...
void ModelicaClassDialog::createModelicaClass()
{
  ...
  if (mpStateCheckBox->isChecked()) {
    ...
    mpMainWindow->getOMCProxy()->addClassAnnotation(nameStructure, "annotate=Icon(graphics={Text(extent={{-100,100},{100,-100}},textString=\"%name\")})");
    mpMainWindow->getOMCProxy()->addClassAnnotation(nameStructure, "annotate=__Dymola_state(true)");
    mpMainWindow->getOMCProxy()->addClassAnnotation(nameStructure, "annotate=singleInstance(true)");
  }
